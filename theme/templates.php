...
<head>
    ...
    <link href="inc/css/price-range.css" rel="stylesheet">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="inc/images/home/logo1.png" alt="" /></a>
            </div> 
          </div>
    ...
    <div class="footer-top">
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="address">
              <img src="inc/images/home/map.png" alt="" />
...
<!-- end -->
    ...
    <!-- jQuery -->
    <script src="<?php echo web_root; ?>inc/jquery/jquery.min.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="<?php echo web_root; ?>inc/js/bootstrap.min.js"></script>

    <!-- Metis Menu Plugin JavaScript --> 
    <!-- DataTables JavaScript -->
    <script src="<?php echo web_root; ?>inc/js/jquery.dataTables.min.js"></script>
    <script src="<?php echo web_root; ?>inc/js/dataTables.bootstrap.min.js"></script>


<script type="text/javascript" language="javascript" src="<?php echo web_root; ?>inc/js/ekko-lightbox.js"></script> 
<script type="text/javascript" src="<?php echo web_root; ?>inc/js/bootstrap-datetimepicker.js" charset="UTF-8"></script>
<script type="text/javascript" src="<?php echo web_root; ?>inc/js/locales/bootstrap-datetimepicker.uk.js" charset="UTF-8"></script>

   
<script src="<?php echo web_root; ?>inc/js/jquery.scrollUp.min.js"></script>
<script src="<?php echo web_root; ?>inc/js/price-range.js"></script>
<script src="<?php echo web_root; ?>inc/js/jquery.prettyPhoto.js"></script>
<script src="<?php echo web_root; ?>inc/js/main.js"></script> 

  <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=true"></script>
    <script type="text/javascript" src="inc/js/gmaps.js"></script>
  <script src="inc/js/contact.js"></script>

    <!-- Custom Theme JavaScript --> 
<script type="text/javascript" language="javascript" src="<?php echo web_root; ?>inc/js/janobe.js"></script> 
 <script type="text/javascript">
